#!/bin/bash
#
# Run two-device DM conversation E2E tests in parallel.
#
...
LOG_A="/tmp/umbra-e2e-dm-user-a.log"
LOG_B="/tmp/umbra-e2e-dm-user-b.log"

# Clean sync state
echo "{}" > "$SYNC_FILE"

echo "═══════════════════════════════════════════════════════"
echo "  Two-Device DM Conversation E2E Test"
echo "═══════════════════════════════════════════════════════"
echo ""
